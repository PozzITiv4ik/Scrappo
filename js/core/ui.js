...
const getCharacterSystem = () => registry.get("character");
...
const setLanguage = (lang) => {
  ...
  const characterSystem = getCharacterSystem();
...
const startGame = () => {
  ...
  const weaponApi = getWeaponApi();
  if (weaponApi && typeof weaponApi.start === "function") {
    weaponApi.start();
  }
};
